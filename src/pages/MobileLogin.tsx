...
const MobileLogin: FC = () => {
  ...
  const goReg = () => navigator('/m/reg')
  const goForgetPass = () => navigator('/m/goforgetpass')
  return (
    <div className="flex justify-center items-center flex-col">
      ...
      <section className="flex items-center flex-col justify-center">
        ...
        <Button className="mx-4! w-[calc(100%-16px)]!" block shape="rounded" color="primary">
          登陆
        </Button>
        <Button
          onClick={goReg}
        ...
        <Button
          ...
          className="mx-4! w-[calc(100%-16px)]!"
          block
          shape="rounded"
          color="success"
        >
