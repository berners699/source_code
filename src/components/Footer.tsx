      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-2xl font-bold text-white mb-4">云游 YunYou</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-blue-400 transition-colors">浏览游戏</a></li>
              <li><a href="#" className="hover:text-blue-400 transition-colors">最新资讯</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-blue-400 transition-colors">联系客服</a></li>
          ...
          <div>
            ...
            <div className="flex">
              <input 
                type="email" 
                placeholder="输入你的邮箱" 
                className="bg-slate-800 text-white px-4 py-2 rounded-l-md focus:outline-none focus:ring-1 focus:ring-blue-500 w-full"
              />
