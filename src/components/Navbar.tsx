...
import { Menu, X, Home, Gamepad2, ShoppingBag, Trophy, Crown, Share2, UserCircle, RefreshCw, LogOut, Coins, Phone, Lock, Shield, Eye, EyeOff } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 shadow-lg">
              ...
              {location.pathname === '/games' ? (
                <div className="flex items-center space-x-4 text-sm text-gray-300">
                  <div className="flex items-center space-x-2">
                    <img src={avatar1} alt="Avatar" className="w-8 h-8 rounded-full border border-gray-600" />
                    <span
                  ...
                  <div className="flex items-center space-x-1 text-yellow-500">
                    <span style={{ color: '#ffffff' }}>保险柜: 0</span>
                    <GoldBean className="w-3.5 h-3.5" />
                  </div>
                  <button className="text-red-500 hover:text-red-400 font-medium">充值</button>
      ...
      <nav 
        className="hidden md:block border-b border-slate-700"
        style={{ 
          backgroundImage: `linear-gradient(to bottom, rgba(15, 23, 42, 0.85), rgba(15, 23, 42, 0.75)), url(${navBg})`,
        ...
        <div className="md:hidden bg-slate-900 border-b border-slate-700">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="pt-4 pb-2 border-t border-slate-800 flex flex-col gap-2 px-3">
              ...
              <button 
                onClick={() => { setAuthMode('register'); setIsAuthModalOpen(true); setIsOpen(false); }}
      ...
      {isAuthModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-[320px] p-6 shadow-2xl animate-in fade-in zoom-in duration-200 overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input 
                    type="text" 
                    placeholder="请输入手机号" 
                    className="w-full bg-slate-800/50 border border-slate-700 rounded-xl py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-800/50 border border-slate-700 rounded-xl py-2.5 pl-10 pr-10 text-sm text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                  />
                  <button 
              ...
              <div className="space-y-1">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-24 h-[42px] bg-slate-800 border border-slate-700 rounded-xl flex items-center justify-center overflow-hidden cursor-pointer hover:bg-slate-700 transition-colors group">
                    <span className="text-lg font-bold italic text-blue-400 tracking-tighter group-hover:scale-110 transition-transform">5639</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-1 space-y-3">
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold py-3 rounded-xl shadow-lg shadow-blue-500/20 transition-all active:scale-[0.98]">
                ...
                <button 
                  ...
                  className="w-full bg-slate-800/50 border border-slate-700 text-slate-300 text-sm font-medium py-2.5 rounded-xl hover:bg-slate-800 hover:text-white transition-all"
                >
